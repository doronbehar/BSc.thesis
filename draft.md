...
Justifying the resemblance of the trapping and cooling parameters in real life to the simulation's code is detailed in the subsequent subsections below.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkxMDc1MDYyNiwtMTAxMjY5ODg5OCwtMT
