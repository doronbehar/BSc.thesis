...
The experimental scheme described above justifies optimizing the cooling process, and hence invite the main effort and research topic of this thesis simulations of the trapping and (sympathetic) cooling our molecule. The simulations were performed by LAMMPS <!--Cite-->, which is capable of simulating numerous physical models useful in multiple contexts, but in our case, I chose a classical model of classical particles (no wave functions) with long-range coulomb interactions, and a classical electrical field resembling the field we actually use in our From the point of view of a computer simulation, all the parameters that can control the can be divided to the groups laid out below:
### Trapping
Frequencies..., pseudo, 
### Cooling
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMDczMTY5NjksLTEwMTI2OTg4OTgsLT
